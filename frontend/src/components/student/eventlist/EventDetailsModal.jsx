...
export default function EventDetailsModal({ event, onClose, onSubmit }) {
  ...
  const handlePaymentConfirm = (method) => {
    onSubmit?.(event, { ...form, paymentMethod: method });
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center gap-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 px-6 py-2.5 text-sm font-semibold text-white shadow-lg hover:shadow-xl transition-all"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
